...
app.use(express.static(path.join(__dirname, '../user-frontend'))); // serve user frontend (html, css, js, images)
app.use('/admin', express.static(path.join(__dirname, '../admin-frontend'))); // serve admin frontend under /admin route

// Redirect /admin and /admin/ to the login page
app.get('/admin', (req, res) => res.redirect('/admin/adminLogin.html'));
app.get('/admin/', (req, res) => res.redirect('/admin/adminLogin.html'));

// Redirect direct file requests to proper routes
app.get('/adminIndex.html', (req, res) => res.redirect('/admin/adminIndex.html'));
app.get('/adminLogin.html', (req, res) => res.redirect('/admin/adminLogin.html'));
