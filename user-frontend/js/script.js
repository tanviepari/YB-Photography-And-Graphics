...
/* Modal close buttons - only bind if elements exist */
...
// 🔹 Render function — only runs on portfolio page
...
// 🔹 Filter buttons — only bind if they exist
if (buttons.length > 0) {
  buttons.forEach(btn => {
...
// 🔹 Lightbox close — only bind if lightbox exists
...
// 🔹 Initial load — only fetch on portfolio page
